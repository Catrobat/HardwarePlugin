...
public class ModifyUserServlet extends HelperServlet {

    private final TemplateRenderer renderer;

    public ModifyUserServlet(UserManager userManager, LoginUriProvider loginUriProvider, TemplateRenderer renderer,
